...
//		}
	...
	private void delProvider(HttpServletRequest request, HttpServletResponse response)
		...
		if(!StringUtils.isNullOrEmpty(id)){
			...
			int flag = context.getBean("providerServiceImpl",ProviderService.class).deleteProviderById(id);
			if(flag == 0){//删除成功
	...
	private void modify(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = false;
		flag =  context.getBean("providerServiceImpl",ProviderService.class).modify(provider);
		if(flag){
	...
	private void getProviderById(HttpServletRequest request, HttpServletResponse response,String url)
		...
		if(!StringUtils.isNullOrEmpty(id)){
			...
			provider =  context.getBean("providerServiceImpl",ProviderService.class).getProviderById(id);
	...
	private void add(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = false;
		flag =  context.getBean("providerServiceImpl",ProviderService.class).add(provider);
		if(flag){
			response.sendRedirect(request.getContextPath()+"/jsp/provider.do?method=query");
		}else{
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
		...
		providerList =  context.getBean("providerServiceImpl",ProviderService.class).getProviderList(queryProName,queryProCode);
