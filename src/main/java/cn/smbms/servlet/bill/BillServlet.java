...
public class BillServlet extends HttpServlet {
  ApplicationContext context =new ClassPathXmlApplicationContext("ApplicationBean_config.xml");
	...
	private void getProviderlist(HttpServletRequest request, HttpServletResponse response)
		...
		providerList = context.getBean("providerServiceImpl",ProviderService.class).getProviderList("","");
	...
	private void getBillById(HttpServletRequest request, HttpServletResponse response,String url)
		...
		if(!StringUtils.isNullOrEmpty(id)){
			Bill bill = null;
			bill = context.getBean("billServiceImpl",BillService.class).getBillById(id);
	...
	private void modify(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = false;
		flag = context.getBean("billServiceImpl",BillService.class).modify(bill);
		if(flag){
	...
	private void delBill(HttpServletRequest request, HttpServletResponse response)
		...
		if(!StringUtils.isNullOrEmpty(id)){
			boolean flag = context.getBean("billServiceImpl",BillService.class).deleteBillById(id);
			if(flag){//删除成功
	...
	private void add(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = false;
		flag = context.getBean("billServiceImpl",BillService.class).add(bill);
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
		...
		billList = context.getBean("billServiceImpl",BillService.class).getBillList(bill);
